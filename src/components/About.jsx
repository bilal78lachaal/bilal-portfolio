...
function About() {
  return (
    <div className="flex flex-col md:flex-row items-start mt-16 px-4 md:px-8 lg:px-16">
      <img
      ...
      <div className="mt-2 text-white font-bold md:w-3/4 bg-black p-6 rounded-lg shadow-lg md:bg-transparent">
